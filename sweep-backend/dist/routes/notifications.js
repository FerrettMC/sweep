...
export async function notificationRoutes(app) {
    ...
    app.post("/notifications/register", { preHandler: requireAuth }, async (request, reply) => {
        ...
        const normalizedPlatform = platform === "ios" || platform === "android" ? platform : null;
    ...
    app.delete("/notifications/register", { preHandler: requireAuth }, async (request, reply) => {
        const userId = request.userId;
    ...
    app.get("/notifications/status", { preHandler: requireAuth }, async (request) => {
