...
async function main() {
    ...
    console.log(`Check OK: $${((previousPrice ?? 0) / 100).toFixed(2)} → $${((newPrice ?? 0) / 100).toFixed(2)}`);
    if (newPrice === null ||
        previousPrice === null ||
