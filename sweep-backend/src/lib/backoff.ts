 ...
 */
export function backoffMultiplier(unchangedChecks: number): number {
  if (unchangedChecks < PATIENCE) return 1;
  if (unchangedChecks < PATIENCE * 2) return 2;
 ...
 */
export function backoffLabel(unchangedChecks: number): string | null {
