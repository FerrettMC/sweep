...
const STRINGS = {
  en: {
    ...
    "plan.noAds": "No ads",
    "plan.sweepCount": "“Sweep this deal” {count}× a day",
    "plan.sweepNone": "“Sweep this deal” — is it really a sale, and is it cheaper elsewhere?",
  ...
  es: {
    ...
    "plan.sweepCount": "«Analizar oferta» {count} veces al día",
    "plan.sweepNone": "«Analizar oferta» — ¿es una oferta real y está más barato en otro sitio?",
